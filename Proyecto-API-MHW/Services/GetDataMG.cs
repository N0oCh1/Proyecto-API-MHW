...
namespace Proyecto_API_MHW.Service
{
    public class GetDataMG
    {
        ...
        public List<DtamonstroGrande> response = new List<DtamonstroGrande>();
        ...
        public List<DtamonstroGrande> GetMonstro()
        {
            foreach(MonstroGrande monstroGrande in monstroGrandes)
            {
                ...
                List<DtaItem> tempItem = new List<DtaItem>();
                List<Elemento> tempElemento = new List<Elemento>();
                List<DtaDebilidad> tempDebilidad = new List<DtaDebilidad>();
                ...
                items.ForEach(item =>
                {
                    ...
                    {
                        tempItem.Add(new DtaItem { id = item.id_item, name = item.nombre_item, description = item.descripcion_item });
                    }
                });
